...
"""
def ex002(args: int, args1: int, args2: int) -> int:
...
"""
def ex006(horas, minutos):
    print(f"{horas}:{minutos}")
    relogio = {1: 13, 2: 14, 3: 15, 4: 16, 5: 17, 6: 18, 7: 19, 8: 20, 9: 21, 10: 22, 11:23, 12: 0}
    if horas in relogio:
