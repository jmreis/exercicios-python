...
class Bola:
    ...
    def __init__(self, cor: str, comprimento: float, material: str) -> None:
        self.cor = cor
        self.comprimento = comprimento
        self.material = material

    def troca_cor(self) -> str:
...
#bola = Bola(cor='vermelho', comprimento=20, material='borracha')
#nova_cor = bola.troca_cor()
...
class Quadrado:
    ...
    def muda_lado(self) -> float:
        self.lado = float(input("Digite o tamanho da aresta do quadrado: "))
        return self.lado
    
    def area(self) -> float:
        return self.lado ** 2

# quadrado = Quadrado(lado=2)
# print(quadrado.lado)
# print(quadrado.area())
...
"""
class Retangulo:
    """Classe para modelar um retangulo
    """

    def __init__(self, comprimento: float, altura: float) -> None:
        self.comprimento = comprimento
        self.altura = altura

    def mostra_comprimento(self) -> str:
        """Escreve o valor no comprimento

        Returns:
            str -- comprimento do retangulo
        """
        return f"{self.comprimento}"
    
    def mostra_altura(self):
        return f"{self.altura}"

    def muda_comprimento(self) -> float:
        self.comprimento = float(input("Digite o comprimento: "))
        return self.comprimento
    
    def muda_altura(self) -> float:
    ...
    def perimetro(self) -> float:
        return (2 * self.altura) + (2 * self.comprimento)

def main():
    comprimento_local = float(input("Digite o comprimento do local: "))
    altura_local = float(input("Digite a altura do local: "))
    local = Retangulo(comprimento=comprimento_local, altura=altura_local)
    area_local = local.area()

    comprimento_piso = float(input("Digite o comprimento do piso: "))
    altura_piso =  float(input("Digite a altura do piso: "))
    piso = Retangulo(comprimento=comprimento_piso, altura=altura_piso)
    area_piso = piso.area()
